...
- mr_description:
  ...
  Description of the MR/PR. If `NULL`, a default description is
  generated including the pipeline ID. Use this to include quality
  metrics (coverage, goodpractice issues, etc.) in the merge request
  body.
